            ...
            <div className="relative w-full h-[350px] md:h-[500px] flex items-center justify-center">
              ...
              {activeIndex === index && (
                <div className="absolute bottom-0 left-0 mr-12 flex items-center ">
                  <div
                    className={`absolute left-0 top-0 w-full h-60 rounded-tl-full rounded-tr-full ${project.circleColor} sm:bg-transparent p-10 opacity-90`}
                  ></div>
                  <div className="relative z-10 text-white ml-3 p-10 sm:hidden">
